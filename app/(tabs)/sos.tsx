...
const PH_EMERGENCY_NUMBERS: EmergencyNumber[] = [
  { id: 'prc', label: 'Red Cross Philippines', number: '143', icon: 'medkit', color: '#E74C3C', description: 'Disaster response & rescue' },
  { id: 'ndrrmc', label: 'NDRRMC Hotline', number: '8911', icon: 'shield', color: '#2980B9', description: 'National disaster risk management' },
  { id: 'pagasa', label: 'PAGASA', number: '8284-0800', icon: 'cloudy', color: '#3498DB', description: 'Weather & typhoon updates' },
  { id: 'phivolcs', label: 'PHIVOLCS', number: '8426-1468', icon: 'earth', color: '#8E44AD', description: 'Earthquake & volcano info' },
  { id: 'bfp', label: 'Bureau of Fire', number: '8426-0246', icon: 'flame', color: '#E67E22', description: 'Fire emergencies' },
  { id: 'pnp', label: 'PNP Hotline', number: '117', icon: 'shield-checkmark', color: '#2C3E50', description: 'Philippine National Police' },
  { id: 'coast_guard', label: 'Coast Guard', number: '8527-3877', icon: 'boat', color: '#1A5276', description: 'Maritime emergencies' },
];
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>Emergency contacts · Philippines</Text>

        {/* 911 big button */}
        <TouchableOpacity
          style={styles.emergencyBtn}
          onPress={() => handleCall('911', 'National Emergency')}
          activeOpacity={0.8}
        >
          <View style={styles.emergencyBtnInner}>
            <Ionicons name="call" size={40} color={colors.white} />
            <View>
              <Text style={styles.emergencyBtnNumber}>911</Text>
              <Text style={styles.emergencyBtnLabel}>National Emergency</Text>
            </View>
          </View>
          <Text style={styles.emergencyBtnSub}>Police · Fire · Medical · Rescue</Text>
        </TouchableOpacity>

        {/* PH hotlines */}
        <Text style={styles.sectionTitle}>Government Hotlines</Text>
        <View style={styles.card}>
          {PH_EMERGENCY_NUMBERS.map((item, idx) => (
        ...
        {customContacts.length === 0 ? (
          <TouchableOpacity style={styles.emptyCard} onPress={() => setAddModal(true)}>
            ...
            <Text style={styles.emptyText}>Add family members, neighbors,{'\n'}or local barangay officials</Text>
          </TouchableOpacity>
        ) : (
          <View style={styles.card}>
        ...
        >
          ...
          <View style={styles.modalSheet}>
            ...
            <TextInput
              ...
              placeholder="e.g. Lola Nena, Barangay Tanod"
            ...
            <TextInput
              ...
              placeholder="Neighbor, relative, barangay..."
              placeholderTextColor={colors.textDim}
              returnKeyType="done"
...
const styles = StyleSheet.create({
  ...
  emergencyBtnSub: { color: colors.white + '99', fontSize: fontSize.sm },
  sectionTitle: {
